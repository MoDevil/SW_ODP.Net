...
namespace ODP1_Connected_Start
{
    public partial class Writer_Form : Form
    {
        ...
        public Writer_Form(int passedWriterId, DataSet sharedDS)
        {
            InitializeComponent();
            ...
            magazinesDS = sharedDS;
            magazinesAdapter = new OracleDataAdapter(cmdstr, ordb);
            new OracleCommandBuilder(magazinesAdapter);
        }
        ...
        private void reviewer_Click(object sender, EventArgs e)
        {
